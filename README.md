...
2.  **Run the Backend:** Navigate to the `apps/server` directory and start the server using `bun dev`. Access the API documentation at `http://localhost:{env.PORT}/docs` (or the deployed endpoint).
