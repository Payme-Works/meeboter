 ...
 */
const LAST_NAMES = [
	"Silva", "Santos", "Oliveira", "Lima", "Costa", "Ferreira", "Rodrigues", "Almeida", "Pereira", "Souza",
	"Barbosa", "Carvalho", "Nascimento", "Ribeiro", "Martins", "Araújo", "Dias", "Fernandes", "Gomes", "Cardoso",
	"Mendes", "Rocha", "Castro", "Moreira", "Azevedo", "Teixeira", "Lopes", "Cunha", "Monteiro", "Freitas",
	"Alves", "Nogueira", "Mendonça", "Miranda", "Vieira", "Correia", "Nunes", "Campos", "Ramos", "Reis",
	"Machado", "Farias", "Melo", "Santana", "Pinto", "Cavalcanti", "Duarte", "Torres", "Andrade", "Barros",
	"Matos", "Coelho", "Medeiros", "Moura", "Peixoto", "Magalhães", "Brito", "Guimarães", "Fonseca", "Vasconcelos",
	"Siqueira", "Borges", "Tavares", "Godoy", "Soares", "Bezerra", "Batista", "Morais", "Carmo", "Porto"
];
	...
	for (let i = 0; i < count; i++) {
		...
		do {
			...
			if (useComposite) {
				...
				if (isFirstPlusFirst) {
					const secondFirstName = FIRST_NAMES[Math.floor(Math.random() * FIRST_NAMES.length)];
